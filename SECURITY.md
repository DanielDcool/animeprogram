...
- The development server binds to `127.0.0.1` by default. Do not reverse-proxy it or expose it to an untrusted network without first reviewing authentication and CORS boundaries.
